...
const MANUFACTURERS = [
  ...
  { key: 'Vaidyaratnam Oushadhasala', short: 'Vaidyaratnam', founded: 1941, founder: 'Vaidyaratnam P. S. Varier lineage / Thaikkattu Mooss family',
    hq: 'Ollur, Thrissur, Kerala', focus: 'Ashtavaidya tradition, kashayams & thailams' },
  { key: 'Oushadhi (Pharmaceutical Corporation IM Kerala)', short: 'Oushadhi', founded: 1941, founder: 'Government of Kerala undertaking',
    hq: 'Thrissur, Kerala', focus: 'Classical Kerala formulations at public-sector pricing' },
  { key: 'Sitaram Ayurveda Pvt. Ltd.', short: 'Sitaram', founded: 1921, founder: 'Vaidyaratnam Sitaram Namboodiri',
    hq: 'Thrissur, Kerala', focus: 'Classical Kerala preparations & proprietary range' },
  { key: 'Nagarjuna Herbal Concentrates Ltd.', short: 'Nagarjuna', founded: 1989, founder: null,
    hq: 'Thodupuzha, Idukki, Kerala', focus: 'Kashayams, thailams & herbal concentrates' },
  { key: 'Pankajakasthuri Herbals India', short: 'Pankajakasthuri', founded: 1988, founder: 'Dr. J. Hareendran Nair',
    hq: 'Thiruvananthapuram, Kerala', focus: 'Respiratory & proprietary Ayurvedic medicine' },
  { key: 'Bipha Drug Laboratories', short: 'Bipha', founded: 1942, founder: null,
    hq: 'Kottayam, Kerala', focus: 'Classical Kerala formulations' },
  { key: 'AVN Ayurveda Formulations Pvt. Ltd.', short: 'AVN', founded: 1930, founder: 'Ashtavaidyan Vaidyaratnam Narayanan Nambi lineage',
    hq: 'Madurai, Tamil Nadu', focus: 'Ashtavaidya tradition, GMP classical range' },
  { key: 'SKM Siddha and Ayurveda', short: 'SKM', founded: 1974, founder: 'Shri S. K. M. Maeilanandhan',
    hq: 'Erode, Tamil Nadu', focus: 'Siddha & Ayurvedic classical preparations' },
  { key: 'Amrutanjan Health Care Ltd.', short: 'Amrutanjan', founded: 1893, founder: 'Kasinadhuni Nageswara Rao',
    hq: 'Chennai, Tamil Nadu', focus: 'Analgesic balms & pain relief' },
  { key: 'Vasu Healthcare Pvt. Ltd.', short: 'Vasu', founded: 1979, founder: null,
    hq: 'Vadodara, Gujarat', focus: 'Research-led proprietary herbal medicine' },
  { key: 'Ban Labs Pvt. Ltd.', short: 'Ban Labs', founded: 1984, founder: null,
    hq: 'Rajkot, Gujarat', focus: 'Proprietary Ayurvedic medicine & personal care' },
  { key: 'Alarsin Pharmaceuticals', short: 'Alarsin', founded: 1943, founder: null,
    hq: 'Mumbai, Maharashtra', focus: 'Physician-prescribed proprietary herbals' },
  { key: 'Gufic Biosciences Ltd.', short: 'Gufic', founded: 1970, founder: null,
    hq: 'Mumbai, Maharashtra', focus: 'Standardised herbal extracts & biosciences' },
  { key: 'Solumiks Herbaceuticals Ltd.', short: 'Solumiks', founded: null, founder: null,
    hq: 'Mumbai, Maharashtra', focus: 'Evidence-based herbaceutical formulations' },
  { key: 'Multani Pharmaceuticals Ltd.', short: 'Multani', founded: 1971, founder: 'Hakim Hari Kishan Lal lineage',
    hq: 'New Delhi', focus: 'Classical Ayurvedic & Unani preparations' },
  { key: 'Shri Ganga Pharmacy', short: 'Shri Ganga', founded: 1955, founder: null,
    hq: 'Haridwar, Uttarakhand', focus: 'Classical churnas, vatis, rasa & bhasma' },
  { key: 'Dindayal Aushadhi Pvt. Ltd.', short: 'Dindayal', founded: 1936, founder: null,
    hq: 'Gwalior, Madhya Pradesh', focus: 'Classical formulations & rasa preparations' },
  { key: 'Jiva Ayurveda', short: 'Jiva', founded: 1992, founder: 'Dr. Partap Chauhan',
    hq: 'Faridabad, Haryana', focus: 'Teleconsultation-led practice & proprietary medicine' },
  { key: 'Sri Sri Tattva', short: 'Sri Sri Tattva', founded: 2003, founder: 'Art of Living Foundation',
    hq: 'Bengaluru, Karnataka', focus: 'Ayurvedic wellness & classical formulations' },
  { key: 'Kapiva Ayurveda', short: 'Kapiva', founded: 2016, founder: 'Ameve Sharma & Shrey Badhani',
    hq: 'Bengaluru, Karnataka', focus: 'Modern-format juices, churnas & supplements' },
  { key: 'Dey\u2019s Medical Stores (Mfg.) Ltd.', short: 'Dey\u2019s', founded: 1914, founder: 'Dr. Kartick Chandra Dey',
    hq: 'Kolkata, West Bengal', focus: 'Ayurvedic & OTC healthcare' },
];
